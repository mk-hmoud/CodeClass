...
export const createProblemController = async (req: Request, res: Response): Promise<void> => {
...
export const getProblemByIdController = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    logMessage(functionName, `Received request to fetch problem ID: ${problemId}`);
...
export const getProblemsController = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    logMessage(functionName, `Fetched ${problems.length} problems for instructor ID: ${instructorId}`);
...
export const deleteProblemController = async (req: Request, res: Response): Promise<void> => {
  const functionName = 'deleteProblemController';
  try {
    const problemId = Number(req.params.problemId);
    logMessage(functionName, `Received request to delete problem ID: ${problemId}`);
